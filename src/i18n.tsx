...
const en: Dict = {
  ...
  'premium.demo.dish': 'Grape leaf dolma',
  'premium.demo.portion': '1 plate (~300 g)',
...
const az: Dict = {
  ...
  'premium.demo.dish': 'Tənək dolması',
  'premium.demo.portion': '1 boşqab (~300 q)',
  'premium.demo.protein': 'Protein',
...
const ru: Dict = {
  ...
  'premium.demo.dish': 'Долма в виноградных листьях',
  'premium.demo.portion': '1 тарелка (~300 г)',
...
const tr: Dict = {
  ...
  'premium.demo.dish': 'Yaprak sarma',
  'premium.demo.portion': '1 tabak (~300 g)',
  'premium.demo.protein': 'Protein',
  'premium.demo.carbs': 'Karb.',
  'premium.demo.fat': 'Yağ',
