      ...
      <div className="am-body">
        ...
        <div className="am-quick">
          {quick.map((q) => (
            <div className="am-tile" style={{ background: q.bg }} key={q.label}>
              <q.Icon size={30} strokeWidth={2.2} />
        ...
        <div className="am-rec-head">
          <div>
            ...
            <p className="am-rec-ai"><Sparkles size={18} /> AI picked just for you</p>
          </div>
        ...
        <div className="am-rec-card">
          ...
          <div className="am-rec-body">
            <div className="am-rec-row">
              ...
              <span className="am-heart"><Heart size={22} /></span>
            </div>
            <p className="am-rec-name">Chocolate Cake</p>
            <div className="am-rec-stats">
              <span><Flame size={20} /> 380</span>
              <span><Users size={20} /> 12g</span>
              <span><Clock size={20} /> 20m</span>
            </div>
            <div className="am-cook-btn">Start Cooking <ChevronRight size={24} /></div>
          </div>
        </div>
  ...
  return (
    <div className="appmock">
      ...
      <div className="am-scan-head">
        <span className="am-scan-close"><X size={28} /></span>
        <span className="am-scan-title">Scan Ingredients</span>
        <span className="am-scan-flash"><Zap size={26} /></span>
      </div>
      ...
      <div className="am-scan-view">
        ...
        <div className="am-scan-cam"><Camera size={36} /></div>
      </div>

      <div className="am-scan-sheet">
        <div className="am-scan-badge"><Sparkles size={20} /> 7 ingredients detected</div>
        <div className="am-chips">
          {found.map((f) => (
            <span className="am-chip" key={f}>{f} <X size={18} /></span>
          ))}
          <span className="am-chip am-chip-add"><Plus size={18} /> Add</span>
        </div>
        <div className="am-scan-cta">Find Recipes <ChevronRight size={26} /></div>
      </div>
    </div>
  );
}
    ...
    <div className="appmock">
      ...
      <div className="am-body">
        ...
        <div className="am-search-row">
          <div className="am-search"><Search size={24} /> <span>Search recipes…</span></div>
          <div className="am-filter"><SlidersHorizontal size={28} /></div>
        </div>

        <div className="am-cats">
          {cats.map((c) => (
            <div className="am-cat" key={c.label}>
              <div className={`am-cat-circle ${c.on ? 'on' : ''}`}><c.Icon size={30} strokeWidth={2} /></div>
